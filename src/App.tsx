...
import FocusExampleIcon from '@material-ui/icons/SettingsEthernet';
...
import FocusExamplePage from './pages/FocusExamplePage';
...
class App extends React.Component<App.Props, App.State> {
    ...
    routes = (
        <div className={this.props.classes.content}>
            ...
            <Route exact={true} path="/focus" component={FocusExamplePage} />
        </div>
    );
    ...
    render() {
        ...
        let drawer = (
            <div>
                ...
                <List>
                    <ListItem button onClick={() => history.push('/focus')}>
                        <ListItemIcon>
                            <FocusExampleIcon />
                        </ListItemIcon>
                        <ListItemText primary="Focus Example" />
                    </ListItem>
                </List>
